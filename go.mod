...
require (
	...
	// gitee.com/deep-spark/go-ixml v1.2.3
...
require gitee.com/deep-spark/go-ixml v0.0.0-20250616014525-a1a4e063554a
...
// Local development override (expected to be a sibling directory of this repo).
replace gitee.com/deep-spark/go-ixml => ../go-ixml
