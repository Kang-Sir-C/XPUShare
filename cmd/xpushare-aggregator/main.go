...
var (
	...
	metricsPath = flag.String("web.telemetry-path", "/xpushare-aggregator", "A path which to expose metrics.")
...
const (
	// the file storing the log of xpushare aggregator
	logPath = "xpushare-aggregator.log"
)
