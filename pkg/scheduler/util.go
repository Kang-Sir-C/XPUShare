...
func (kss *XPUShareScheduler) printPodStatus(ps *PodStatus) {
	if ps == nil {
...
// func (kss *XPUShareScheduler) caculateTotalPods(namespace, podGroupName string) int {
...
func (kss *XPUShareScheduler) calculateBoundPods(podGroupName, namespace string) int {
