...
/** for regular pod **/
// xpushare treats gpu resource as rare resource
// if the node without gpu, node score will be set to 100
// otherwise, node score will be set to be 0
func (kss *XPUShareScheduler) calculateRegularPodNodeScore(nodeName string) float64 {
...
func (kss *XPUShareScheduler) calculateOpportunisticPodScore(nodeName string, podStatus *PodStatus) float64 {
...
func (kss *XPUShareScheduler) calculateOpportunisticPodNodeScore(cellList CellList) float64 {
	if cellList == nil {
		return 0
	}
...
/** for guarantee pod **/
func (kss *XPUShareScheduler) calculateGuaranteePodScore(nodeName string, podStatus *PodStatus) float64 {
	model := podStatus.model
	score := 0.0
	if model != "" {
...
func (kss *XPUShareScheduler) calculateGuaranteePodNodeScore(cellList CellList, podGroup string) float64 {
	if cellList == nil {
		return 0
	}
...
/*
func (kss *XPUShareScheduler) queryPodFromPodGroup(podGroup string) []model.LabelSet {
...
func (kss *XPUShareScheduler) getCellIDFromPodGroup(podGroup string) []string {
...
func (kss *XPUShareScheduler) filterPodGroup(podGroup string) []string {
	cellIDList := []string{}
...
func (kss *XPUShareScheduler) getCellIDDistance(current []string, id string) float64 {
...
func (kss *XPUShareScheduler) getModelLeafCellbyNode(nodeName, model string) CellList {
...
func (kss *XPUShareScheduler) getAllLeafCellbyNode(nodeName string) CellList {
...
// get the leaf cell
func (kss *XPUShareScheduler) getLeafCellbyNode(cell *Cell, nodeName string) CellList {
...
/*for Reserve*/
func (kss *XPUShareScheduler) calculateOpportunisticPodCellScore(nodeName string, podStatus *PodStatus) CellList {
	model := podStatus.model
	// get cell list
	var cellList CellList
...
func (kss *XPUShareScheduler) calculateGuaranteePodCellScore(nodeName string, podStatus *PodStatus) CellList {
	model := podStatus.model
	// get cell list
	var cellList CellList
