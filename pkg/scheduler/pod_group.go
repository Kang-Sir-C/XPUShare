...
func (kss *XPUShareScheduler) getOrCreatePodGroupInfo(pod *v1.Pod, ts time.Time) *PodGroupInfo {
...
func (kss *XPUShareScheduler) getPodGroupLabels(pod *v1.Pod) (string, int, float64, int) {
...
func (kss *XPUShareScheduler) podGroupInfoGC() {
	kss.podGroupMutex.Lock()
	defer kss.podGroupMutex.Unlock()
