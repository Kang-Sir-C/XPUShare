...
def main():
    ...
    parser.add_argument('--port', type=int, default=50050, help='base port')
    parser.add_argument('--config', default='/xpushare/scheduler/test/GPU-cc12e01c-1473-e6b2-d0ac-9b96e9c3e60b', help='resource config file')
    ...
    for idx in range(1, n + 1):
        ...
        proc = sp.Popen(
            ...
            env=prepare_env(idx, name, '0.0.0.0', port, args.port),
            stderr=sp.DEVNULL,
            stdout=sp.PIPE
        )
